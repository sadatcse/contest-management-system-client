...
const Navbar = () => {
  ...
  const handleLogOut = () => {
    ...
    <li><NavLink to="/contest">All Contest</NavLink></li>
    { user && <>
...
return (
  <div className="navbar bg-base-100 border-solid border-2 border-gray-100">
    <div className="navbar-start">
      ...
      <div className="flex items-center">
        <img src="https://i.ibb.co/jLBtFLj/logo.png" alt="Company Logo" className="h-2/4 w-2/4 mr-2" />
      </div>
    </div>
 ...
 <ul>
  <li className="text-xl">{user.displayName}</li>
